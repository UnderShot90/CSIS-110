...
print ("Are You Ready!!!")
question =  raw_input('If youre ready Please enter Yes or No: ')
if question  == "Yes" or question =='yes':
   question1 = raw_input('Are you a silly goose Please enter Yes or No: ')
   question2 = raw_input('Are you a sad Please enter Yes or No: ')
...
#adds my piano phrase to my piano part
...
#adds my piano parts to my score
   if question1 == "Yes" or question1 == 'yes':
      Mod.shuffle(myScore)
#shuffles my music
   if question2 == 'yes' or question2 == 'Yes':
      Mod.elongate(piano1Part,1.5)
      Mod.elongate(piano2Part,1.5)
      #this messes up my start times but it makes it so much more interseting
else:
   myNote = Note (E2, HN)
   Play.midi (myNote)
   print("goodbye")
